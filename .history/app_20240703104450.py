...
def download_contact_messages():
    ...
    # Write CSV headers
    writer.writerow(['ID', 'Name', 'Email','Mobile', 'Message', 'Created At'])  # Adjust headers based on your model fields
    
    # Write data rows
    for message in contact_messages:
        writer.writerow([message.id, message.name, message.email,message.mobile, message.message, message.created_at])  # Adjust based on your model fields
